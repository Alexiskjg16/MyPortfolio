    ...
    render() {
        return (
            <div>
                ...
                But if you know the right questions to ask and where to look for the answers, that takes a lot of pressureoff. So go easy on yourself if you don’t spit out answers right away! </p>
                ...
                Water Bottle, 
                Fidget Spinner(if you have trouble sitting still like me!)</p>
